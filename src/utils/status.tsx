...
import { getMainLoopModelSetting, modelDisplayString } from './model/model.js';
...
export function getModelDisplayLabel(mainLoopModel: string | null): string {
  if (mainLoopModel === null) {
    const configuredModel = getMainLoopModelSetting();
    if (configuredModel === undefined) {
      return 'Not configured';
    }
    if (!isModelAllowed(configuredModel)) {
      return `Unavailable (${configuredModel})`;
    }
  }
