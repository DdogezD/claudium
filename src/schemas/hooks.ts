...
function buildHookSchemas() {
  ...
  const PromptHookSchema = z.object({
    ...
    model: z
      ...
      .optional()
      .describe(
        'Model to use for this prompt hook (e.g., "my-model-id"). If not specified, uses the configured model.',
      ),
    statusMessage: z
      .string()
      .optional()
  ...
  const AgentHookSchema = z.object({
    ...
    model: z
      ...
      .optional()
      .describe(
        'Model to use for this agent hook (e.g., "my-model-id"). If not specified, uses the configured model.',
      ),
    statusMessage: z
      .string()
      .optional()
