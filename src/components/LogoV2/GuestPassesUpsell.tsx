...
export function GuestPassesUpsell() {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    t0 = <Text dimColor={true}><Text color="startupAccent">[✻]</Text> <Text color="startupAccent">[✻]</Text>{" "}<Text color="startupAccent">[✻]</Text> ·{" "}{reward ? `Share Claudium and earn ${formatCreditAmount(reward)} of extra usage · /passes` : "3 guest passes at /passes"}</Text>;
    $[0] = t0;
  } else {
    t0 = $[0];
  }
