...
import { logEventTo1P } from '../services/analytics-stub.js';
      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Claudium&apos;s functionality (eg. to reduce the risk of bugs
