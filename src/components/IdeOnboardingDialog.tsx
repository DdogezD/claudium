...
export function IdeOnboardingDialog(t0) {
  ...
  let t6;
  if ($[8] !== ideName) {
    t6 = <>{t5}<Text>Welcome to Claudium for {ideName}</Text></>;
    $[8] = ideName;
    $[9] = t6;
  } else {
    t6 = $[9];
  ...
  if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
    t11 = <Text>• Review Claudium's changes{" "}{t10}{" "}<Text color="diffRemovedWord">-22</Text> in the comfort of your IDE</Text>;
    $[13] = t11;
  } else {
    t11 = $[13];
  }
